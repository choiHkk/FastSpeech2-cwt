    ...
    while True:
        ...
        for batch in loader:
            ...
            if step % log_step == 0:
                ...
                message2 = "TL: {:.4f}, ML: {:.4f}, MPL: {:.4f}, EL: {:.4f}, DL: {:.4f}, CL: {:.4f}, BL: {:.4f}, CS: {:.4f}, CSM: {:.4f}, CSS: {:.4f}, US: {:.4f}".format(
                    *losses
                )
            ...
            if step % synth_step == 0:
                ...
                log(
                    ...
                    step=step, 
                    fig=fig,
                    tag="Training/step_{}".format(step),
                )
                ...
                log(
                    ...
                    tag="Training/step_{}_reconstructed".format(step),
                )
                log(
                    train_logger,
                    step=step, 
                    ...
                    sampling_rate=sampling_rate,
                    tag="Training/step_{}_synthesized".format(step),
                )
